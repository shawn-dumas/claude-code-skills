...
If a spec has an `ASSERTION_IMPLEMENTATION` finding and the related SUT has
surviving mutants, mention the cross-reference in the structural finding's
description. Do not bump its priority -- mutation evidence is orthogonal to
P8 violation severity.
