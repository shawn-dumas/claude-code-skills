...
- Named export using function declaration: `export function ComponentName({ ... }: Props) { ... }`
- Props typed inline on the function parameter or as a local interface
- Do not use `React.FC` or `FC` type annotations -- type props directly
