...
export const cliConfig: ObservationToolConfig<EnvAccessAnalysis> = {
  cacheNamespace: 'ast-env-access',
  helpText: HELP_TEXT,
  analyzeFile: analyzeEnvAccess,
  analyzeDirectory: analyzeEnvAccessDirectory,
};
