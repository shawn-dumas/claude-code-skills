...
export const cliConfig: ObservationToolConfig<NullDisplayAnalysis> = {
  cacheNamespace: 'null-display',
  helpText: HELP_TEXT,
  analyzeFile: analyzeNullDisplay,
  analyzeDirectory: analyzeNullDisplayDirectory,
};
