...
export const cliConfig: ObservationToolConfig<NumberFormatAnalysis> = {
  cacheNamespace: 'number-format',
  helpText: HELP_TEXT,
  analyzeFile: analyzeNumberFormat,
  analyzeDirectory: analyzeNumberFormatDirectory,
};
