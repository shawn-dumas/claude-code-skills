...
export const cliConfig: ObservationToolConfig<JsxAnalysis> = {
  cacheNamespace: 'jsx-analysis',
  helpText: HELP_TEXT,
  analyzeFile: analyzeJsxComplexity,
  analyzeDirectory: analyzeJsxComplexityDirectory,
};
