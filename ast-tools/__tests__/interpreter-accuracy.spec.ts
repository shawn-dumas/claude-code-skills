...
/**
 * Compute the domain directory for a subject path.
 * Mirrors getDomainDir from ast-interpret-test-quality.ts.
 */
function getTestQualityDomainDir(subjectPath: string): string {
...
function evaluateEntryFixture(
  ...
  // manifest are companion subjects or mock targets needed for resolution.
