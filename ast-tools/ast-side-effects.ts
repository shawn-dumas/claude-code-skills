...
export const cliConfig: ObservationToolConfig<SideEffectsAnalysis> = {
  cacheNamespace: 'side-effects',
  helpText: HELP_TEXT,
  analyzeFile: analyzeSideEffects,
  analyzeDirectory: analyzeSideEffectsDirectory,
};
