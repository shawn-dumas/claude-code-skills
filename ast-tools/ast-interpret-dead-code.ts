...
import type { ImportObservation, ObservationRef, AssessmentResult, Assessment } from './types';
 ...
 */
export function interpretDeadCode(observations: readonly ImportObservation[]): AssessmentResult<DeadCodeAssessment> {
